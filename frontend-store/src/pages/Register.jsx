            ...
            <div className="text-center space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-left">
                <p className="text-sm text-blue-900">
                  <strong>💡 Tip:</strong> The verification link will expire in 24 hours. If you don't receive it, check your spam folder or{' '}
                  <button onClick={() => setRegistered(false)} className="text-blue-600 hover:underline font-semibold">
                    try again
                  </button>.
                </p>
              </div>
